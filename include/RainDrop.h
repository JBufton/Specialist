...
class RainDrop
{
  ...
  void WindResistance(float *, float); //based upon the resulting direction etc calculates the wind resistance (strength depending upon the weight
  void GroundPlaneFriction(float *, float);    //Calculates the friction of the raindrops when they are on the floor
